...
def opt(parser):
  ...
  parser.add_option('--xmin',action='store',dest='xmin',type="float",default=None,help="min bound x axis [not for 2D map]")
  parser.add_option('--ymin',action='store',dest='ymin',type="float",default=None,help="min bound y axis [not for 2D map]")
  parser.add_option('--xmax',action='store',dest='xmax',type="float",default=None,help="max bound x axis [not for 2D map]")
  parser.add_option('--ymax',action='store',dest='ymax',type="float",default=None,help="max bound y axis [not for 2D map]")
